...
public class ProfileService {
    ...
    // Precisa de @Transactional próprio (não herdar o readOnly=true da classe): getMine
    // chama getOrCreate() dentro da mesma classe (self-invocation), e o proxy do Spring
    // não intercepta essa chamada interna — sem isso, o save() de dentro do getOrCreate()
    // roda "dentro" da transação somente-leitura herdada e falha.
    @Transactional
