...
// Nome "SocialProfileController" (não "ProfileController") de propósito: o
// spring-boot-starter-data-rest já registra um bean interno chamado "profileController"
// (org.springframework.data.rest.webmvc.RestControllerConfiguration) — usar o mesmo nome
// de classe colide e derruba a aplicação inteira ao subir (BeanDefinitionOverrideException).
@RestController
...
public class SocialProfileController {
    ...
    public SocialProfileController(ProfileService profileService) {
